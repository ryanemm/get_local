...
final String listingId;
  ...
  const ApplicantProfileScreen({super.key, required this.applicationId, required this.listingId,});
...
class _ApplicantProfileScreenState extends State<ApplicantProfileScreen> {
  ...
  Future<List<AccountDetailsLocal>> getUserAccount() async {
    ...
    const jsonEndpoint = "http://139.144.77.133/getLocalDemo/getUserAccount.php";
    ...
    try {
      ...
      switch (response.statusCode) {
        case 200:
          ...
          var formatted =
              userAccounts.map((userAccount) => AccountDetailsLocal.fromJson(userAccount)).toList();
          print(formatted);
  ...
  Future sendInterviewInvite() async {
    ...
    const jsonEndpoint = "http://139.144.77.133/getLocalDemo/send_interview_invite.php";
   ...
   List<WorkHistoryItem> workHistoryItems = [
    ...
    WorkHistoryItem(
      ...
      description: 'Assisting in the development of web applications and customer support.',
    ),
        WorkHistoryItem(
      title: 'General Labour',
      company: 'Kosi Connect',
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      Text("Work History:", style: GoogleFonts.montserrat(
                          color: Colors.black,
                          fontSize: 16,
                          fontWeight: FontWeight.normal)),
                          SizedBox(height: 16),
                         ...
                         Expanded(
                           child: ListView.builder(
                                   ...
                                   itemBuilder: (context, index) {
                                     return WorkHistoryCard(title: workHistoryItems[index].title, description: workHistoryItems[index].description,
                                     duration: workHistoryItems[index].duration, company: workHistoryItems[index].company,);
                                   },
                                 ),
                         ),
