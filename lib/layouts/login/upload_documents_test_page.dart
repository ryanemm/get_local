...
class UploadDocumentsTestPage extends StatefulWidget {
  String? password;
  String? name;
  String? surname;
  String? email;
  ...
  @override
  State<UploadDocumentsTestPage> createState() =>
      _UploadDocumentsTestPageState();
}

class _UploadDocumentsTestPageState extends State<UploadDocumentsTestPage> {
  ...
  Future<void> uploadFilesWithNewNames(
                                ...
                                GradientButton(
                                  ...
                                  function: () async {
                                    ...
                                    await uploadFilesWithNewNames1(documents, [
                                      "user_$user_id\_id.pdf",
                                      "user_$user_id\_proof_of_res.pdf",
                                      "user_$user_id\_CV.pdf"
                                    ]);
                                  },
                                ),
                                SizedBox(height: 16),
